...
import { LayoutDashboard, UserPlus, Sparkles, KeyRound, GitBranch, Trophy, Wallet, WalletCards, BadgeIndianRupee, LogIn, Coins, Settings as SettingsIcon } from "lucide-react";
...
const nav: DashboardNavItem[] = [
  ...
  { href: "/promax-admin/daily-payouts", label: "Daily Payouts", icon: <Coins className="h-4 w-4" /> },
